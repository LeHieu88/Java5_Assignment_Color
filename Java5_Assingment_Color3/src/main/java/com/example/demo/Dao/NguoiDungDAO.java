...
public interface NguoiDungDAO extends JpaRepository<NguoiDung, Integer> {
    ...
    void updateNguoiDung(@Param("userName") String userName, @Param("hoTen") String hoTen, @Param("matKhau") String matKhau, @Param("email") String email, @Param("diaChi") String diaChi, @Param("soDienThoai") String soDienThoai, @Param("chucVu") Boolean chucVu);
